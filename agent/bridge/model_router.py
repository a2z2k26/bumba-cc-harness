...
# This exact model ID is used regardless of smart routing tier.
CAREFUL_OPUS_MODEL = "claude-opus-4-5-20251001"
...
class ModelRouter:
    ...
    TIERS = {
        "simple": {"model": "claude-haiku", "cost_per_msg": 0.001},
        "medium": {"model": "claude-sonnet", "cost_per_msg": 0.01},
        "complex": {"model": "claude-opus", "cost_per_msg": 0.05},
    }
