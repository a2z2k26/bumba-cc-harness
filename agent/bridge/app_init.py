...
from .app import (
    ...
    _validate_codex_oauth, apply_command_tier_gating, load_commands_section,
    load_config, logger, record_completed_span, time,
)
...
class BridgeAppInit:
    ...
    async def run(self) -> None:
        ...
        # Persistent Claude process for text messages (haiku/sonnet).
        # Opus falls back to one-shot ClaudeRunner.invoke() for isolation.
