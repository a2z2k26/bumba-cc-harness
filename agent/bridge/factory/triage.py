...
DEFAULT_REPO: Final[str] = "your-org/bumba-cc-harness"
...
def _invoke_claude(prompt: str) -> tuple[int, str, str]:
    """Spawn `claude -p` with no tools and a structured-output prompt.
...
def classify_issue(
    ...
    *,
    ...
    Args:
        ...
        repo: owner/name slug. Defaults to your-org/bumba-cc-harness.
...
def triage_workflow(
    *,
    ...
    Args:
        repo: owner/name. Defaults to your-org/bumba-cc-harness.
