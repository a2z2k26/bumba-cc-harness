...
class TestSessionContext:
    ...
    def test_with_active_tasks(self):
        ctx = SessionContext(
            active_tasks=[
                {"id": 1, "title": "Implement verification", "status": "in_progress", "project": "bumba-cc-harness"},
            ],
            pending_approvals=[],
            stale_tasks=[],
            recent_decisions=3,
...
class TestFormatSessionContext:
    ...
    def test_active_tasks_formatted(self):
        ctx = SessionContext(
            active_tasks=[
                {"id": 12, "title": "Implement verification hooks", "status": "in_progress", "project": "bumba-cc-harness"},
...
class TestBuildSessionContext:
    ...
    async def test_build_with_active_tasks(self):
        ...
        task_row = {"id": 7, "title": "Refactor auth", "status": "in_progress",
                    "priority": "high", "assigned_to": None, "project": "bumba-cc-harness",
