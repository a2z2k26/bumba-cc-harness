...
Usage (CLI — for manual testing):
    python3 -m scripts.evidence --repo your-org/bumba-cc-harness --dry-run
...
class RepoEvidenceSpec:
    ...
    name: str
    """Fully-qualified repo name, e.g. ``your-org/bumba-cc-harness``."""
...
async def create_pr_with_evidence(
    *,
    ...
    Args:
        ...
        repo: Fully-qualified repo name, e.g. ``"your-org/bumba-cc-harness"``.
