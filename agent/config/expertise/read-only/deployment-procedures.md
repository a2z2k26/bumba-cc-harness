...
- Post-D6-bis (2026-05-09): source clone at `/opt/bumba-harness/agent-flat/` IS the runtime; the legacy split between `/home/bumba/Documents/bumba-cc-harness/agent/` (admin) and `/opt/bumba-harness/agent/` (runtime) is retired. Workstation operator authoring (`/home/operator/bumba-cc-harness/`) still goes through PR review.
...
- PRs go to `your-org/bumba-cc-harness` on GitHub (private repo)
